...
namespace Dimon {
	...
	void Renderer2D::Init()
	{
		...
		Ref<VertexBuffer> squereVB =VertexBuffer::Create(vertices2, sizeof(vertices2));
		...
		Ref<IndexBuffer> squereIB = IndexBuffer::Create(indices2, sizeof(indices2) / sizeof(uint32_t));
		...
		s_Renderer2DStorage->TextureShader = Shader::Create("Textura","aseets/shader/Texture.vert", "aseets/shader/Texture.frag");
